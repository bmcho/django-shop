...
class User(AbstractUser):
    ...
    email_verified = models.BooleanField(defualt=False)
...
class Product(TimeStampedModel):
    ...
    phoyo = models.ImageField(blank=True)
...
class Rating(TimeStampedModel):
    ...
    def __str__(self):
        return f"[{self.product.name}] by {self.user} <{self.rating}>"
...
class PopUp(TimeStampedModel):
    ...
    width = models.IntegerField(null=True, black=True)
    height = models.IntegerField(null=True, black=True)
...
class Payment(TimeStampedModel):
    ...
    delivery_invoice = models.CharField(max_length=100, defualt="OrderNo: 12312")
